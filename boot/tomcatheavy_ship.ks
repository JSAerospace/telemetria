...
FUNCTION LogS2 {
    ...
    LOCAL file IS "0:/telemetry_ship_A.json".
    WRITEJSON(data, file).
...
// ============================================================
// === 6. HOT STAGING (Starship Style) ===
// ============================================================
PRINT "Esperando Hot Staging (AG7)...".
LogS2("HOT STAGING STANDBY").
WAIT UNTIL AG7.

HUDTEXT("HOT STAGING — S2 IGNITION", 5, 2, 30, GREEN, FALSE).
PRINT "HOT STAGING CONFIRMADO. Ignicion S2...".
LogS2("HOT STAGING").

// Ignición inmediata
AG1 ON.
LOCK THROTTLE TO 1.0.
FOR e IN SHIP:ENGINES { e:ACTIVATE(). }

// Esperar separación física
WAIT UNTIL AG8 OR SHIP:PARTS:LENGTH < initialParts.

HUDTEXT("HOT STAGING SUCCESSFUL — SEPARATION CONFIRMED", 5, 2, 30, CYAN, FALSE).
PRINT "SEPARACION CONFIRMADA.".
LogS2("ASCENT").
WAIT 0.5.
