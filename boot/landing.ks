...
FUNCTION GetCurrentTarget {
    ...
    // Fallback search for Barge vessel if nothing selected
    IF rawT = 0 {
        LIST TARGETS IN tL.
...
UNTIL FALSE {
    ...
    IF hasTR {
        // CORTE POR ENERGÍA: Si el impacto ya está tras el punto de overshoot (1.8km tras la barca)
        IF LngErr > 300 { 
            PRINT "Trajectory Overshoot Reached (1.8km Buffer).".
            BREAK. 
        }
